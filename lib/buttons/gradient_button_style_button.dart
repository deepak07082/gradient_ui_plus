...
abstract class GradientButtonStyleButton extends StatefulWidget {
  /// Create a [GradientButtonStyleButton].
  ...
  /// The gradient to be applied to the background
...
/// See also:
///
///  * [GradientButtonStyleButton], the [StatefulWidget] subclass for which this class is the [State].
...
class _ButtonStyleState extends State<GradientButtonStyleButton>
  ...
  Widget build(BuildContext context) {
    ...
    if (resolvedAnimationDuration! > Duration.zero &&
        ...
        _backgroundColor!.toARGB32() != resolvedBackgroundColor!.toARGB32() &&
        _backgroundColor!.a == 255 &&
        resolvedBackgroundColor.a < 255 &&
        resolvedElevation == 0) {
